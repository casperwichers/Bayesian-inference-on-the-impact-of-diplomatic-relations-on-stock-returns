metropolis_delta_2layer <- function(start,
  ...
  b = (log_target_density_delta_2layer(delta = theta_star, alpha, beta_tilde, Sigma_eta,
                                rho, F_t, nu, y,
                                min_network, plus_network) 
       + log_proposal_delta(theta_ini, nu))
  
  a = (log_target_density_delta_2layer(delta = theta_ini, alpha, beta_tilde, Sigma_eta,
                                rho, F_t, nu, y,
                                min_network, plus_network)
