...
#                        alpha, vec_beta_star, j, Sigma, delta, rho,
#                        returns, F_t,
...
sample_rho <- function(rho, alpha, vec_beta_star, Sigma, 
                       delta, returns, F_tilde,
                       m_min_network, m_plus_network,
                       v_min_network, v_plus_network,
                       rho_params){
