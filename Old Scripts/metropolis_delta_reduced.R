metropolis_delta_reduced <- function(start,
                             alpha_star, vec_beta_star, rho, Sigma_eta,
                             nu, F_t, y,
  ...
  b = (log_target_density_delta_reduced(delta = theta_star, alpha_star, vec_beta_star, Sigma_eta,
                                rho, F_t, nu, y,
                                m_min_network, m_plus_network,
                                v_min_network, v_plus_network) 
       + log_proposal_delta(theta_ini, nu))
  
  a = (log_target_density_delta_reduced(delta = theta_ini, alpha_star, vec_beta_star, Sigma_eta,
                                rho, F_t, nu, y,
                                m_min_network, m_plus_network,
                                v_min_network, v_plus_network)
